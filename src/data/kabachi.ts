...
export const RESTAURANT_INFO = {
  ...
  hours: '9:00 AM – 10:00 PM Daily', // {{HOURS}}
  openHour: 9, // 9:00 AM
  ...
  tiktok: 'https://www.tiktok.com/@officialkabachi',
  x: 'https://x.com/kabachilagos',
  bankTransferDetails: {
    bankName: '{{BANK_NAME}}',
...
export const MENU_ITEMS: MenuItem[] = [
  // Starters (2 items)
  {
    ...
    ingredients: [
      ...
      'Handmade wheat wonton pastry',
      'Fresh spring onions',
      'Ginger juice reduction',
      'Toasted pure sesame oil',
      'Light premium soy',
    ],
    allergens: ['Crustaceans / Shellfish', 'Gluten', 'Soy', 'Sesame'],
    dietary: ['Pork-free', 'Halal-friendly chicken', 'High Protein'],
    spiceLevel: 0,
    preparationNote: 'Folded daily and steamed to order in traditional bamboo baskets. Served with seasoned light soy dip.',
  },
  {
    id: 'kb-02',
    ...
    ingredients: [
      ...
      'Wood ear mushrooms',
      'Clear mung bean glass noodles',
      'Crisp spring pastry shell',
      'White pepper and sesame drizzle',
    ],
    allergens: ['Gluten', 'Soy', 'Sesame'],
    dietary: ['Vegetarian', 'Pork-free', 'Dairy-free'],
    spiceLevel: 0,
    preparationNote: 'Hand-rolled fresh every morning and flash-fried in clean vegetable oil for a light, shatter-crisp crunch.',
  },
  ...
  // Rice (2 items)
  {
    ...
    ingredients: [
      'Aged long-grain fragrant rice',
      'Tiger prawns',
      'Tender shredded flank beef',
      'Fresh free-range eggs',
      'Sweet green peas',
      'Fresh scallions',
      'Dark mushroom soy',
      'Aromatic wok aromatics',
    ],
    allergens: ['Crustaceans / Shellfish', 'Egg', 'Soy', 'Gluten'],
    dietary: ['Pork-free', 'Signature House Dish'],
    spiceLevel: 1,
    preparationNote: 'Wok-tossed over extreme 100,000 BTU jet burners to infuse natural smoky wok hei into every individual grain.',
  },
  {
    id: 'kb-04',
    ...
    ingredients: [
      ...
      'Tender chicken breast shreds',
      'Wok-whipped egg ribbons',
      'Sweet garden peas',
    ...
    dietary: ['Pork-free', 'Halal-friendly chicken', 'Mild & Comforting'],
    spiceLevel: 0,
    preparationNote: 'Prepared in classic Cantonese style with light golden color and delicate sesame finish without heavy soy.',
  },
  ...
  // Noodles (2 items)
  {
    ...
    ingredients: [
      ...
      'Crisp tri-color bell peppers',
      'Sweet yellow onion',
      'Fragrant Madras curry spice blend',
      'White toasted sesame seeds',
    ],
    allergens: ['Crustaceans / Shellfish', 'Sesame', 'Soy'],
    dietary: ['Pork-free', 'Rice-based Noodle'],
    spiceLevel: 2,
    preparationNote: 'Dry-charred in an iron wok with aromatic curry powders so the delicate rice noodles remain springy and dry.',
  },
  {
    id: 'kb-06',
    ...
    ingredients: [
      'Cantonese egg wheat noodles',
      'Thinly sliced marinated flank beef',
      'Fresh bok choy greens',
      'Crisp bean sprouts',
      'Crushed garlic cloves',
      'Dark aged mushroom soy',
      'Shaoxing reduction style seasoning',
    ],
    allergens: ['Gluten', 'Egg', 'Soy'],
    dietary: ['Pork-free', 'High Protein'],
    spiceLevel: 1,
    preparationNote: 'Egg noodles are seared hot on the wok base until lightly crisp, then tossed with tender velvety beef slices.',
  },
  ...
  // Chicken (2 items)
  {
    ...
    ingredients: [
      'Crispy boneless chicken cubes',
      'Whole dried red chilies',
      'Cracked citrus Szechuan peppercorns',
      'Fresh minced garlic',
      'Young ginger slices',
      'Chili bean paste',
      'Crisp scallion batons',
    ],
    allergens: ['Soy', 'Gluten'],
    dietary: ['Pork-free', 'Halal-friendly chicken', 'Fiery Specialty'],
    spiceLevel: 3,
    preparationNote: 'Double-fried chicken tossed in toasted Szechuan peppercorns for the authentic tingling sensation and crisp crunch.',
  },
  {
    id: 'kb-08',
    ...
    ingredients: [
      'Tender chicken breast bites in light batter',
      'Fresh golden pineapple chunks',
      'Crisp red & green bell peppers',
      'Sweet red onions',
      'House plum and tomato glaze',
      'Aged rice vinegar',
    ],
    allergens: ['Gluten', 'Soy'],
    dietary: ['Pork-free', 'Halal-friendly chicken', 'Mild Sweet & Tangy'],
    spiceLevel: 0,
    preparationNote: 'Chicken pieces are flash-fried to order and glazed immediately with freshly simmered fruit vinegar sauce.',
  },
  ...
  // Beef (2 items)
  {
    ...
    ingredients: [
      'Prime aged flank beef shreds',
      'Heaped fresh garlic paste',
      'Crisp green bell peppers',
      'Black wood ear mushrooms',
      'Fermented red chili paste',
      'Ginger and dark soy reduction',
    ],
    allergens: ['Soy', 'Gluten'],
    dietary: ['Pork-free', 'Rich & Garlicky'],
    spiceLevel: 2,
    preparationNote: 'Velveted beef strips seared vigorously with fragrant crushed garlic and rich spicy brown sauce.',
  },
  {
    id: 'kb-10',
    ...
    ingredients: [
      'Finely cut prime flank beef matchsticks',
      'Fresh young ginger matchsticks',
      'Long sliced scallions',
      'Sweet dark soy caramel',
      'Pure honey drizzle',
      'Toasted sesame seeds',
    ],
    allergens: ['Soy', 'Gluten', 'Sesame'],
    dietary: ['Pork-free', 'Crispy Texture'],
    spiceLevel: 1,
    preparationNote: 'Deep-fried until the edges are deliciously caramelized and crisp, then quickly glazed with pungent warm ginger sauce.',
  },
  ...
  // Seafood (1 item)
  {
    ...
    ingredients: [
      'Wild jumbo tiger prawns (whole shell-on)',
      'Crushed coarse sea salt',
      'Cracked black peppercorns & white pepper',
      'Fine green bird eye chilies',
      'Golden crispy fried garlic flakes',
      'Finely sliced scallions',
    ],
    allergens: ['Crustaceans / Shellfish'],
    dietary: ['Pork-free', 'Gluten-free Friendly', 'Chef Special'],
    spiceLevel: 2,
    preparationNote: 'Flash-fried shell-on so the exterior becomes delicately crisp and edible, tossed dry with savory spiced sea salt.',
  },
  ...
  // Drinks (1 item)
  {
    ...
    ingredients: [
      'Brewed organic Nigerian hibiscus calyces (zobo)',
      'Freshly squeezed lime juice',
      'Pounded spicy ginger root',
      'Sweet orange peel infusion',
      'Crisp sparkling tonic water',
      'Cane sugar',
    ],
    allergens: [],
    dietary: ['Vegan', 'Gluten-free', 'Caffeine-free', 'House Craft Cooler'],
    spiceLevel: 0,
    preparationNote: 'Slow cold-brewed for 18 hours in the Kabachi bar, carbonated and served ice-cold with fresh lime wheels.',
  },
];
...
export interface StoreStatus {
  isOpen: boolean;
  shortStatus: 'OPEN' | 'CLOSED';
  nextActionText: string;
  statusText: string;
  lagosTimeString: string;
  hoursDisplay: string;
}

/**
 * Calculates current time in Africa/Lagos (UTC+1) timezone regardless of visitor's computer location.
 */
export function getLagosTime(): { hours: number; minutes: number; totalMinutes: number; timeString: string } {
  try {
    ...
    return { hours, minutes, totalMinutes: hours * 60 + minutes, timeString };
  } catch {
    // Robust fallback: UTC+1
    const now = new Date();
    const utcHours = now.getUTCHours();
    const utcMinutes = now.getUTCMinutes();
    const lagosHours = (utcHours + 1) % 24;
    const timeString = `${String(lagosHours).padStart(2, '0')}:${String(utcMinutes).padStart(2, '0')}`;
    return { hours: lagosHours, minutes: utcMinutes, totalMinutes: lagosHours * 60 + utcMinutes, timeString };
  }
}

/**
 * Real-time restaurant open/closed status logic for Kabachi (9:00 AM – 10:00 PM Lagos Time).
 * 9:00 AM exactly -> OPEN
 * 9:01 AM -> OPEN
 * 1:00 PM -> OPEN
 * 9:59 PM -> OPEN
 * 10:00 PM -> CLOSED
...
export function getStoreStatus(): StoreStatus {
  const { hours, minutes, totalMinutes, timeString } = getLagosTime();
  // 9:00 AM is 9 * 60 = 540 minutes
  const openMinutes = 9 * 60; // 540
  // 10:00 PM is 22 * 60 = 1320 minutes
  const closeMinutes = 22 * 60; // 1320

  const isOpen = totalMinutes >= openMinutes && totalMinutes < closeMinutes;
  const shortStatus: 'OPEN' | 'CLOSED' = isOpen ? 'OPEN' : 'CLOSED';
  const nextActionText = isOpen ? 'Closes at 10:00 PM' : 'Opens at 9:00 AM';
  const statusText = `${shortStatus} · ${nextActionText}`;
  ...
  return {
    ...
    nextActionText,
    statusText,
    lagosTimeString: timeString,
    hoursDisplay: RESTAURANT_INFO.hours,
  };
}
